...
class RenderEngine:
    ...
    # Divides the a range 0 to be "count" into "parts." The last part might be smaller than the others.
    ...
    """ Renders the 3D scene into a 2D image using ray tracing. """
    ...
    """ Find the first object hit by the ray in the scene"""
    def find_nearest(self, ray, scene):
        ...
        for obj in scene.objects:
            ...
            # If the object is hit by the ray and the distance is less than the minimum distance.
